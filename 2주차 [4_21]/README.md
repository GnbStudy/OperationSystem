...
[ 2주차목표 ] : 동시성, 스레드, 프로세스를 공부한 후, 사용자모드/커널모드 복습하기.
...
[ 학습자료파일 ]
 ⊙ 위의 학습내용에 대한 학습자료는 kakaotalk 이미지 파일을 참고하면 된다.
 ⊙ 위의 학습내용을 다 익혔으면, exp1, exp2, exp3 이미지 파일과 RamenProgram.zip 파일의 소스파일을 참고해 공부하면 된다.
